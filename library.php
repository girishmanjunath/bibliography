...
<div class="myaccount">
  <table>
  <th><a href="library.php">User profile</a></th>
  <th><a href="mysettings.php">User Settings</a></th>
...
<?php }
    ...
    <td width="732" valign="top">
		<h3 align="right" class="titlehdr">Welcome <?php echo $_SESSION['user_name'];?> to Bibliography Manager</h3>  
...
<div class="scrollcell">
            <table border="3" bordercolor="black" bgcolor="white" width="80%" cellspacing="3" cellpadding="2" scrollbars="yes">
                <tr>
                    <td>Title</td> 
                ...
                <tr>
                    <td height="30">Abstract</td> 
                    <td><textarea rows="3" cols="100" name="add_abstract" id="add_abstract"></textarea></td>
                </tr>
	...
	<p>
        Sort created refrences by:
        <select name="Sort By">
            <option selected="yes">Asc</option>
            <option>Desc</option>
        </select>
        </p>
            <table border="3" bordercolor="black" bgcolor="lightgrey" width="80%" cellspacing="2" cellpadding="5">
                <tr>
                    <th>All</th>
