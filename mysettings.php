...
<h3 class="titlehdr">User Settings</h3>
      <p> 
        <?php	
	if(!empty($err))  {
	   echo "<div class=\"msg\">";
      ...
      <h3 class="titlehdr">Change your Password</h3>
      <p>If you want to change your password, please put your old and new password 
        to make changes.</p>
      <form name="pform" id="pform" method="post" action="">
        <table width="60%" border="0" align="center" cellpadding="3" cellspacing="3" class="forms">
          <tr> 
        ...
        <p align="center"> 
          <input name="doUpdate" type="submit" id="doUpdate" value="Update your password">
        </p>
        <p>&nbsp; </p>
      </form>
      <p>&nbsp; </p>
