...
<body>
 ...
 <form action="index.php" method="post" name="logForm" id="logForm" >
  <h1>Bibliography Manager member log in</h1>  
  ...
  <div class="p-container">    
   <input name="doLogin" type="submit" id="doLogin3" value="Login"></br>
    
  </div>
  <p align="center" class="p-container">
  </br><a href="register.php">New user can register here, for FREE</a><font color="black"> 
   </font>   </p>      
